...
void do_scheduler(void)
{
    ...
    // printl("name=%s PGDIR = %d %ld\n",(*current_running)->name,kva2pa((*current_running)->pgdir),((PTE *)(*current_running)->pgdir)[0]);
    PTE *pmd = (PTE *)pa2kva(get_pa(((PTE *)(*current_running)->pgdir)[0]));
    // printl("pmd = %d\n",pmd[0]);
    PTE *pmd2 = (PTE *)pa2kva(get_pa(pmd[0]));  
    // printl("pmd2 = %d | %d\n",pmd2[16], pmd2[17]);
